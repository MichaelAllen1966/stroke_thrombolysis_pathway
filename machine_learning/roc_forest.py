...
def plot_roc(false_positive_rate, true_positive_rate, area_under_curve_mean):
    ...
    area_under_curve_mean = np.around(area_under_curve_mean, 3)
    auc_text = 'AUC = ' + str(area_under_curve_mean)
    ax1.text(0.65, 0.03, auc_text, backgroundcolor = '1.0') 
...
for train_index, test_index in skf.split(X, y):
    ...
    model = train_model_forest (X_train_std,y_train)
